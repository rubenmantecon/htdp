...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname ex-245) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
;; Note: this is taken from @aduec on GitHub
...
; have capabilities in the language that allow us to programatically
; inspect the contents of a function.

;; Extra note: the 'first easily definable idea for which you cannot define [such] a function' is the idea of... infinity?